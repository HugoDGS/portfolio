...
export default function Contact() {
  return (
    <section id="contact" className="py-28 px-6 bg-[#0a0d16]">
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-500 max-w-md mx-auto">
            Open to full-stack and security opportunities. Feel free to reach out.
          </p>
        </motion.div>
        ...
        >
          {links.map((link) => (
            <a
              ...
              className="flex items-center gap-3 bg-[#0f1117] border border-[#1e2433] hover:border-indigo-500/50 rounded-xl px-6 py-4 text-gray-300 hover:text-white transition-all group"
            >
        ...
        <motion.p
          ...
          className="text-center text-gray-700 text-xs mt-16"
        >
